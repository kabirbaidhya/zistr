...
describe('ZistrRequest', () => {
  ...
  it('should initialize with mandatory fields', () => {
    const req = new ZistrRequest(defaultInit);
  ...
  describe('generics type safety', () => {
    it('should allow strongly typed body, query, params, context', () => {
      ...
      type QueryType = { active: string };
      type ParamsType = { id: string };
      type ContextType = { userId: string };

      const req = new ZistrRequest<BodyType, QueryType, ParamsType, ContextType>({
        ...defaultInit,
        body: { name: 'Alice' },
        query: { active: 'true' },
        params: { id: '123' },
      ...
      const queryActive: string = req.query.active;
  ...
  it('should initialize with minimal data', () => {
    const req = new ZistrRequest(minimalInit);
